...
namespace SitesDemo
{
    ...
    class Program
    {
        ...
        static public String DOMAIN = "site";
        static public String SITE_NAME = "srirambridgetest";
        private SitesService service = null;
        private SitesA sa = null;
        ...
        static void Main(string[] args)
        {
            ...
            String username = "indianbridge@gmail.com";
            String password = "merabharatmahan";
        ...
        public void run()
        {
            try
            {
                ...
                sa.appendText("Num Pages = " + feed.Entries.Count);
                //Console.WriteLine("Num Pages = " + feed.Entries.Count);
                if (feed.Entries.Count > 0)
                {
                    AtomEntry entry = feed.Entries[0];
                    entry.Title.Text = "SriramSuper";
                    service.Update(entry);
                    sa.appendText("Success");
                    //Console.WriteLine("Success");
                }
            }
            catch (Exception e)
            {
                sa.appendText(e.ToString());
            }
        }

        private String makeFeedUri(String type)
        {
            return "https://sites.google.com/feeds/content/site/srirambridgetest?path=/test";
