...
function validate_path($wp_fileman_path)	## Validate path
{
...
function is_hidden_file($wp_fileman_path)	## Checks whether the file is hidden.
{
...
function is_hidden_directory($wp_fileman_path)	## Checks whether the directory is hidden.
{
...
function get_linked_path($wp_fileman_path,$base_url)	## Get path with links to each folder
{
