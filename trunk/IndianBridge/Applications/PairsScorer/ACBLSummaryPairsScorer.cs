...
namespace IndianBridge.Applications
{
    ...
    public partial class ACBLSummaryPairsScorer : Form
    {
        ...
        private void checkCredentials_Button_Click(object sender, EventArgs e)
        {
            ...
            String scope = "http://www.google.com/calendar/feeds/indianbridge@gmail.com/private/full";
            ...
            if (proceed) ControlTabs.SelectTab("SelectEventTab");
        }
