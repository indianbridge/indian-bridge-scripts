...
{
    public struct PairsEventInformation
    {
    ...
    public struct PairsDatabaseParameters
    {
        public DataSet m_ds;
    ...
    public class PairsGeneral
    {
        public static PairsEventInformation m_eventInformation;

        public static String constructDatabaseFileName(String rootFolder, String eventName, DateTime eventDate)
        {
            return Path.Combine(rootFolder, "Databases",eventDate.ToString("yyyy-MM-dd") + "_" + Utilities.makeIdentifier_(eventName) + ".mdb");
        }
        public static String constructWebpagesDirectory(String rootFolder, String eventName, DateTime eventDate)
        {
            return Path.Combine(rootFolder, "Webpages", eventDate.ToString("yyyy-MM-dd") + "_" + Utilities.makeIdentifier_(eventName));
        }
