...
if (!class_exists('BFI_Event_To_Post')) {
    ...
    class BFI_Event_To_Post {
        ...
        public function __construct() {
            $this->custom_post_type = 'ai1ec_event';
        ...
        function postFromEventTransitionHook($new_status, $old_status, $event) {
            ...
            if ($event->post_type == $this->custom_post_type && !wp_is_post_autosave($event) && $new_status == 'publish') {
        ...
        function getContentPrefix($eventID) {
            ...
            if ($event != null) {
                ...
                $this->writeDebug('Getting event is null');
